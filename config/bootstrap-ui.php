...
return [
    ...
    */
    'pagination' => [
        /*
        |--------------------------------------------------------------------------
        | Erste und letzte Seiten
        |--------------------------------------------------------------------------
        |
        | Zeige die Button Erste und letzte Seite?
        |
        */
        ...
        |--------------------------------------------------------------------------
        |
        | Soll der Text "Zeige 1 bis 10 von 50" angezeigt werden?
        |
        */
        'show_summary' => true,
        /*
        ...
        |--------------------------------------------------------------------------
        |
        | Sollen Pfeile (<< >>) oder Text (Zurück/Weiter) genutzt werden?
        |
        */
        'use_icons' => true,
]
